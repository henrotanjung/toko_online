<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/purchase') ?>">
          <i class="fas fa-fw fa-database"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/partner/supplier') ?>">
          <i class="fas fa-users"></i>
          <span>Suplier</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/partner/customer') ?>">
          <i class="fas fa-users"></i>
