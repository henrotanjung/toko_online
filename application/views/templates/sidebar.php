<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/peralatan_olah_raga'); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="navbar">
              <ul class="nav navbar-nav navbar-right">
                <li>
                  <?php $kerajang = 'Keranjang Belanja: ' . $this->cart->total_items() . ' items'; ?>
                  <?php echo anchor('dashboard/detail_keranjang', $kerajang); ?>
                </li>
              </ul>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                if ($this->session->userdata('username')) { ?>
                  ...
                  <li class="ml-2"><?php //echo anchor('auth/logout', 'Logout') 
                                    ?></li> -->

                  <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <span class="mr-2 d-none d-lg-inline text-gray-600 small">Valerie Luna</span>
                      <img class="img-profile rounded-circle" src="<?php echo base_url('uploads/laptop.jpg') ?>">
                    </a>
